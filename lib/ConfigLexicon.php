...
class ConfigLexicon implements ILexicon {
	...
	public function getAppConfigs(): array {
		return [
			...
			new Entry(key: self::TEAM_FOLDER_DEFAULT_QUOTA, type: ValueType::INT, defaultRaw: self::DEFAULT_QUOTA, definition: 'default quota in bytes for all team folders (0 means unlimited)', lazy: true),
			// OIDC
