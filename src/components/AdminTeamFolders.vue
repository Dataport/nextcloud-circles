...
const selectedAssignmentTeam = ref<AdminTeamFolder | null>(null)
...
async function openAssignDialog(team: AdminTeamFolder) {
	selectedAssignmentTeam.value = team
...
async function assignTeamFolder() {
	...
	const teamId = selectedAssignmentTeam.value.teamId
...
function addTeam() {
	...
	rows.value.push({ ...selectedQuotaTeam.value, quota: quotaOption(104857600) })
